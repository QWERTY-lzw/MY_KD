...
# AP = (0.9247133731842041,),  2.05 M, 0.75 GLOPS
arch={'widen_factor_backbone_idx': (0, 0, 5, 2, 2), 'deepen_factor_backbone_idx': (2, 2, 1, 3), 'widen_factor_neck_idx': (0, 0, 0, 0, 0, 0, 0, 0), 'widen_factor_neck_out_idx': 4}
