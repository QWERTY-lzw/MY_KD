...
# AP = (0.9201194047927856,),  1.97 M, 0.69 GLOPS
arch={'widen_factor_backbone_idx': (0, 0, 4, 2, 2), 'deepen_factor_backbone_idx': (2, 2, 1, 3), 'widen_factor_neck_idx': (0, 0, 0, 0, 0, 0, 0, 0), 'widen_factor_neck_out_idx': 4}
