...
# AP = (0.8820254802703857,),  0.38 M, 0.18 GLOPS
arch={'widen_factor_backbone_idx': (1, 2, 1, 1, 0), 'deepen_factor_backbone_idx': (2, 2, 2, 1), 'widen_factor_neck_idx': (0, 0, 0, 0, 0, 0, 0, 0), 'widen_factor_neck_out_idx': 1}
