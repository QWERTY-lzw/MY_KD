...
# AP = (0.8968945741653442,),  0.54 M, 0.36 GLOPS
arch={'widen_factor_backbone_idx': (5, 0, 4, 0, 0), 'deepen_factor_backbone_idx': (0, 2, 3, 1), 'widen_factor_neck_idx': (0, 0, 0, 0, 0, 0, 0, 0), 'widen_factor_neck_out_idx': 2}
