...
#, AP (0.860194981098175,), 0.33 M, 0.15 GFLOPS
arch={'widen_factor_backbone_idx': (1, 2, 1, 1, 0), 'deepen_factor_backbone_idx': (0, 3, 1, 3), 'widen_factor_neck_idx': (4, 3, 0, 5, 3, 5, 3, 4), 'widen_factor_neck_out_idx': 1}
