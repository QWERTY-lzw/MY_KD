...
#, AP (0.8564814925193787,), 0.35 M, 0.15 GFLOPS
arch={'widen_factor_backbone_idx': (1, 2, 0, 2, 0), 'deepen_factor_backbone_idx': (1, 1, 2, 3), 'widen_factor_neck_idx': (2, 5, 1, 5, 3, 1, 1, 4), 'widen_factor_neck_out_idx': 1}
