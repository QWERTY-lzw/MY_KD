...
#, AP (0.8789457082748413,), 0.76 M, 0.26 GFLOPS
arch={'widen_factor_backbone_idx': (2, 3, 2, 1, 2), 'deepen_factor_backbone_idx': (1, 3, 1, 2), 'widen_factor_neck_idx': (5, 0, 1, 4, 5, 5, 2, 1), 'widen_factor_neck_out_idx': 1}
