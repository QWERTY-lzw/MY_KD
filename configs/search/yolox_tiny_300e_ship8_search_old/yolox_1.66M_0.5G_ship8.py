...
#AP (0.8918834328651428,), 1.66 M, 0.5 GFLOPS
arch={'widen_factor_backbone_idx': (1, 3, 3, 4, 2), 'deepen_factor_backbone_idx': (2, 2, 2, 2), 'widen_factor_neck_idx': (4, 5, 1, 4, 5, 5, 4, 2), 'widen_factor_neck_out_idx': 2}
