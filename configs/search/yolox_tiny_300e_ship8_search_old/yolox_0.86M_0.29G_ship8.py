...
#AP (0.8804038763046265,), 0.86 M, 0.29 GFLOPS
arch={'widen_factor_backbone_idx': (1, 3, 2, 2, 2), 'deepen_factor_backbone_idx': (3, 3, 1, 1), 'widen_factor_neck_idx': (1, 4, 3, 4, 2, 3, 1, 4), 'widen_factor_neck_out_idx': 1}
