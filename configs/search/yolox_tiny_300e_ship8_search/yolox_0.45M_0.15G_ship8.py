...
#, AP (0.8969459533691406,), 0.45 M, 0.15 GFLOPS
arch={'widen_factor_backbone_idx': (0, 0, 1, 1, 0), 'deepen_factor_backbone_idx': (2, 1, 1, 3), 'widen_factor_neck_idx': (0, 0, 2, 2, 0, 4, 1, 0), 'widen_factor_neck_out_idx': 1}
...
base_in_channels = [int(c*default_widen_factor) for c in [256, 512, 1024]]
