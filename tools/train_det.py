...
from mmdet_custom.apis import init_random_seed, set_random_seed, train_detector
from mmdet.datasets import build_dataset
from mmdet.utils import collect_env, get_root_logger, setup_multi_processes

from mmdet_custom.distillation import build_distiller
...
def parse_args():
    ...
    parser.add_argument(
        '--pretrained', help='the pretrained file')
    parser.add_argument(
        '--auto-resume',
        action='store_true',
