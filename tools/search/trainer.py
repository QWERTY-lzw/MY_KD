...
def parse_args():
    ...
    parser.add_argument('--params-limit', type=float, default=5, help='M (1e6)')
    parser.add_argument('--flops-limit', type=float, default=None, help='G (1e9)')  # 17.651 M 122.988 GFLOPS
